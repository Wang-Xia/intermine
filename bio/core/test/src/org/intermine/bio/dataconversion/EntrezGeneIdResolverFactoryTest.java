...
public class EntrezGeneIdResolverFactoryTest extends TestCase {
    ...
    public void testCreateIdResolver() throws Exception {
        ...
        factory.createFromFile(entrezFile, new HashSet<String>(Arrays.asList(new String[] {"7227", "4932", "10090", "7955", "9606"})));
        assertTrue(IdResolverFactory.resolver.getTaxons().size() == 6);
        assertEquals(new LinkedHashSet<String>(Arrays.asList(new String[] {"7955", "102", "4932", "101", "10090", "9606"})), IdResolverFactory.resolver.getTaxons());
        ...
        String humanGene = IdResolverFactory.resolver.resolveId("9606", "gene", "ENSG00000121410").iterator().next();
        assertTrue("1".equals(humanGene));
    }
}
